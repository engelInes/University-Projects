...
public class ReadFileStmt implements  IStmt{
    ...
    public ProgramState execute(ProgramState state) throws ExpressionEvaluationException, DivisionByZero, IOException, StatementExecutionException {
        ...
        if(symTable.isDefined(varName))
        {
            ...
            {
                IValue val2 = exp.eval(symTable); //get name of the file
