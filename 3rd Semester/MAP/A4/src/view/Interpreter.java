...
public class Interpreter {
    public static void main(String[] args)
    {
        ...
        textMenu.addCommand(new RunExample2("2","example2",ctrl2));
        textMenu.addCommand(new RunExample3("3", "example3",ctrl3));
        textMenu.addCommand(new RunExample4("4","example4",ctrl4));
        textMenu.addCommand(new RunExample4("5","example5 with reading from file",ctrl5));
